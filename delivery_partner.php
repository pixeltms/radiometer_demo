...
$Partner_array = 
array(
array('1','DHL','https://dhl/tracking/','34.56'),
array('2','First Flight','https://firstflight/tracking/','4893.45'),
array('3','DTDC','https://dtdc/tracking/','234.50'),
...
$selected_Partner = $Partner_array[$_GET['id'] - 1];
                ...
                <div class="card-body">
                  ...
                  <form>
                    <div class="form-group">
						...
						<input type="text" class="form-control" id="Partner_id" value=<?php echo $selected_Partner[0];?> >
                    </div>	
                    <div class="form-group">
						<label for="Partner_sku">Partner Name</label>
						<input type="text" class="form-control" id="Partner_sku"  value=<?php echo $selected_Partner[1];?>>
                    </div>	
                    <div class="form-group">
						<label for="Partner_name">Tracking URL</label>
						<input type="text" class="form-control" id="Partner_name"  value=<?php echo $selected_Partner[2];?>>
